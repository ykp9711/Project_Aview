               ...
               <div class="inner">
                  ...
                  <div class="container">   
                  	 <section id="content">
						...
						<h3><a href="/serviceList/service" class="button small">목록 보기</a>&nbsp&nbsp&nbsp
						 <button id="delete"class="button small" style="width:170px; float:right; ">게시글 삭제</button></h3>
			                        <form method="post" action="/serviceList/modify">
			                           <div class="fields">
			                              ...
			                              <div class="field">
			                                 <h4>내용</h4>
			                                 <input name="content" type="text" value="${list.content}"/>
			                              </div><br>
			                              <div class="field">
			                                 <h4>작성자</h4>
