	...
	<div class="container">
		...
		<ul class="actions">
			<li style="margin: 0 auto;">
				<button class="button primary" onclick="show_login()">학생로그인
				</button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<div class="row gtr-uniform" id="login_box" style="display: none;">
			<div class="col-6 col-12-medium" style="margin: 0 auto;">
				...
				<form name="loginForm" action="/member/stulogin" method="post">
					...
					<p align="right">
						<a href="/member/stuFindId" style="font-size: 13px">아이디 또는 비밀번호 찾기</a>
		...
		<div class="row gtr-uniform" id="login_box_aca" style="display: none;">
			<div class="col-6 col-12-medium" style="margin: 0 auto;">
				<div class="box">
					...
					<p align="right">
						<a href="/member/findIDaca" style="font-size: 13px">아이디 또는 비밀번호 찾기</a>
					</p>
					<br>
